        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex space-x-4">
              ...
              <Link href="/monitor" className="px-4 py-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors">
                监控看板
              </Link>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-cyan-100">
            ...
            <p className="text-gray-600">
              Excel(.xlsx/.xls)、Word(.docx)，智能识别文件结构
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-cyan-100">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">异步高性能</h3>
            <p className="text-gray-600">
              异步事件驱动，支持 10,000 行/分钟吞吐量，上传即返回
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-cyan-100">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">全链路可观测</h3>
            <p className="text-gray-600">
              实时监控看板、Trace 追踪、错误精细化定位，1分钟内定位问题
            </p>
          </div>
        </div>
